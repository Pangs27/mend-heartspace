...
import { Menu, X, Heart, LogOut, User, Sun, MessageCircle, BookOpen, TrendingUp, Sparkle, Users, LucideIcon } from "lucide-react";
...
const protectedNavLinks: NavLink[] = [
  ...
  { name: "Deepen Your Reflection", path: "/sessions", icon: Sparkle },
