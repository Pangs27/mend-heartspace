      ...
      <section className="gradient-hero py-20 lg:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              MEND is designed to be your everyday emotional companion — a safe space to reflect, understand, and grow at your own pace.
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard
              ...
              description="Express yourself freely. Our AI companion reflects back your emotions with clarity and understanding, helping you see what you're truly feeling."
              variant="lilac"
              delay={0}
            />
            <FeatureCard
            ...
            <FeatureCard
              ...
              description="When you need human guidance, connect with verified mental health professionals for focused 20-minute micro-sessions."
              variant="lilac"
              delay={0.3}
            />
            <FeatureCard
