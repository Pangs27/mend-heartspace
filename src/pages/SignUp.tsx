      ...
      >
        ...
        <div className="bg-card rounded-3xl p-8 shadow-card">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-serif font-medium text-foreground mb-2">Create your account</h1>
            <p className="text-sm text-muted-foreground">Begin your emotional wellness journey</p>
          </div>
